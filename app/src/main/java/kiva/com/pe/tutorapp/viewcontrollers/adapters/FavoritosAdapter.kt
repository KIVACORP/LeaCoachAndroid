...
class FavoritosAdapter(var files: ArrayList<Favorite>, val context: Context): RecyclerView.Adapter<FavoritosAdapter.ViewHolder>(){
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): FavoritosAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(p0: FavoritosAdapter.ViewHolder, p1: Int) {
